...
export default function ContactForm() {
	...
	if (status === "success") {
		return (
			<div className="flex flex-col flex-1 justify-between gap-12 px-6 py-12 sm:px-12 lg:py-16">
				<div className="flex flex-col gap-8 sm:gap-16">
					<p className="font-mono text-nav text-secondary">02 / sent</p>

					<div className="flex items-center gap-3">
						<div className="w-2 h-2 bg-accent" />
						<p className="font-sans text-heading-sm sm:text-heading-lg font-medium text-primary-text">brief received</p>
					</div>
				...
				<div className="flex flex-col">
					...
					<div className="grid grid-cols-[90px_1fr] sm:grid-cols-[120px_1fr] gap-4 py-3 border-b border-hairline-inner font-mono text-metadata">
						...
						<p className="font-bold text-primary-text break-all">{sentTo}</p>
					</div>
				</div>
	...
	return (
		<form onSubmit={handleSubmit} noValidate className="flex flex-col gap-8 px-6 py-12 sm:px-12 lg:py-16">
